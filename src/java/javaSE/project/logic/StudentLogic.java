...
public class StudentLogic implements StudentLogicI {
    ...
    public boolean add(Student student) throws SQLException{
        PreparedStatement preparedStatement = this
                .dbConnectionI
                .getConnection()
                .prepareStatement("INSERT INTO student(name, registrationNo, course, idNumber) VALUES(?, ?, ?, ?)");
    ...
    public boolean update(Student student)  throws SQLException{
        PreparedStatement preparedStatement = this
                .dbConnectionI
                .getConnection()
                .prepareStatement("UPDATE student SET name = ?, registrationNo = ?, course = ?, idNumber = ? WHERE id = ?");
        preparedStatement.setString(1, student.getName());
        preparedStatement.setString(2, student.getRegistrationNo());
        preparedStatement.setString(3, student.getCourse());
        preparedStatement.setString(4, student.getIdNumber());
    ...
    public boolean delete(Student student)  throws SQLException{
        PreparedStatement preparedStatement = this
                .dbConnectionI
                .getConnection()
                .prepareStatement("DELETE FROM student WHERE registrationNo = ?");
        preparedStatement.setString(1, student.getRegistrationNo());
        return dbConnectionI.execute(preparedStatement);
    }
    ...
    public Student find(String registrationNo) throws SQLException {
        PreparedStatement preparedStatement = this
                .dbConnectionI
                .getConnection()
                .prepareStatement("SELECT * FROM student WHERE registrationNo = ?");
